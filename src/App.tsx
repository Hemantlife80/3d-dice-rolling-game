...
const DiceGame = () => {
    ...
    useEffect(() => {
        ...
        const createDiceFace = (number: number) => {
    ...
    const rollDice = async () => {
        ...
        const rotationMap: { [key: number]: { x: number, y: number, z: number } } = {
                            ...
                            <div className="flex gap-2">
                                {[1, 2, 3, 4].map(n => (
                                    <button
                                        ...
                                        className={`flex-1 py-3 rounded-lg font-semibold transition-all ${numPlayers === n ? 'bg-amber-700 text-white shadow-lg scale-105' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                                    >{n}</button>
                                ))}
                            </div>
                        </div>
                            ...
                            <div className="flex gap-2">
                                {[30, 50, 75, 100].map(score => (
                                    <button
                                        ...
                                        className={`flex-1 py-2 rounded-lg font-semibold text-sm transition-all ${targetScore === score ? 'bg-amber-700 text-white shadow-lg scale-105' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
                                    >{score}</button>
                                ))}
                            </div>
                        </div>
                        <button onClick={startGame} className="w-full py-4 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold text-lg rounded-lg hover:from-amber-700 hover:to-amber-800 shadow-lg transform hover:scale-105 transition-all">
                            Start Game
                        </button>
                    </div>
                </div>
        ...
        return (
          <div className="w-full h-screen bg-gradient-to-br from-amber-900 via-yellow-800 to-amber-900 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
              ...
              <button onClick={resetGame} className="px-8 py-4 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-bold text-lg rounded-lg hover:from-amber-700 hover:to-amber-800 shadow-lg transform hover:scale-105 transition-all">
                Play Again
              </button>
            </div>
          </div>
